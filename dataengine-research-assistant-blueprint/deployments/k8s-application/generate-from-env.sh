...
SECRETS="RAG_USERNAME RAG_PASSWORD RAG_DEFAULT_COLLECTION VASTDB_ENDPOINT VASTDB_ACCESS_KEY VASTDB_SECRET_KEY AGENT_OPENAI_API_KEY GOOGLE_API_KEY AUTH__AZURE__CLIENTID AUTH__AZURE__CLIENTSECRET AUTH__AZURE__NEXTAUTHSECRET"
