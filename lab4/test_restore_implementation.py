...
def test_restore_implementation():
    ...
    try:
        ...
        print()
        print("# List files in snapshot with path filter")
        print("python lab4_solution.py --list-snapshot-files 'test-snapshot-20250116-120000' --protected-path test_snapshot --path-prefix 'data/'")
        print()
